//Musa Jallow
//One of the components of milestone game group.
//Group: Gavin Mojica, myself, Johan Congrains, Jason Walker
//7.17.2020
/*
let score = 0;
let win;
...
background(0);
textSize (25);
text("You've won. Good job", 200, 200)
//Not M.V.P.
//Image Gavin chooses for win screen goes here.

//If user presses play again, the game restarts.
//It will go back to the title screen.
//My variable stands in for the title screen right now.
let restart = true;
}//closes win if-statement.
*/
//Musa Jallow
//7.19.2020
//Trying to recreate milestone game.
...
let enemyXpos = 250;
let enemyYpos = 250;
let enemyDirectionX = 5;
let enemyDirectionY = 6;
//Variable that wil store score and will check if the player has won.
let score = 0;
let win = false;
let lose = false;
...
background(0);
textSize (25);
text("You've won. Good job", 150, 150);
...
//Image Gavin chooses for win screen goes here.
    ...
    background(0);
    textSize(25);
    text("Sorry, you've lost.", 150, 150);
    //Making sure the game doesn't continue after it's over.
myXpos = 0;
myYpos = 0;
woodXpos = 0;
